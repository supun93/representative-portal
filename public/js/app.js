...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    triggerButtonCallBack: function triggerButtonCallBack(callBack, recordIndex, rowIndex, slotIndex) {
      var slot = this.records[recordIndex].rows[rowIndex][slotIndex];
    ...
    finalizeUI: function finalizeUI() {
      var obj = this;
    ...
    prepareUIRecords: function prepareUIRecords() {
      var obj = this;
      var uiRecords = [];
      var records = obj.records;
    ...
    buildRows: function buildRows() {
      ...
      if (slots.length > 0) {
        ...
        if (rowSlots.length > 0) {
          ...
          var maxEndTime = this.maxEndTime;
          var currStartTime = minStartTime;
    ...
    hasTaken: function hasTaken(startTime, endTime, takenSlots) {
      var obj = this;
      var taken = false;

      if (takenSlots.length > 0) {
        var formatTFHF = obj.getStartEndDateObj(startTime, endTime);
        ...
        takenSlots.forEach(function (takenSlot) {
          var slotStart = takenSlot.startTime;
          var slotEnd = takenSlot.endTime;
          var formatTFHF = obj.getStartEndDateObj(slotStart, slotEnd);
          slotStart = formatTFHF.startTime;
          slotEnd = formatTFHF.endTime;
          var slotStartTs = slotStart.getTime();
          var slotEndTs = slotEnd.getTime();
    ...
    setDimensions: function setDimensions() {
      var hourRowWidth = document.getElementById("hours-row").offsetWidth;
      var singleSlotSecs = this.slotMinutes * 60;
      var startTime = this.minStartTime;
      var endTime = this.maxEndTime;

      if (startTime !== "" && endTime !== "") {
        var formatTFHF = this.getStartEndDateObj(startTime, endTime);
        startTime = formatTFHF.startTime;
        endTime = formatTFHF.endTime;
        var secondsDiff = (endTime.getTime() - startTime.getTime()) / 1000;
        var slotsCount = secondsDiff / singleSlotSecs;
        this.setHourSlots(startTime.getTime() / 1000, slotsCount);
        var slotWidth = hourRowWidth / slotsCount;
        this.slotWidth = parseInt(slotWidth + "");
      }
    },
    setHourSlots: function setHourSlots(startTS, slotsCount) {
      var singleSlotSecs = this.slotMinutes * 60;
      var hourSlots = [];
      ...
      if (slotsCount > 0) {
        ...
        for (var i = 1; i <= slotsCount; i++) {
          var time = this.getTimeForTimestamp(currTS);
    ...
    getTimeForTimestamp: function getTimeForTimestamp(timestamp) {
    ...
    getSlotWidth: function getSlotWidth(startTime, endTime) {
      var width = 0;
      ...
      if (startTime !== "" && endTime !== "") {
        ...
        var secondsDiff = (endTime.getTime() - startTime.getTime()) / 1000;
        var singleSlotSecs = this.slotMinutes * 60;
        var slotCount = secondsDiff / singleSlotSecs;
    ...
    getStartEndDateObj: function getStartEndDateObj(startTime, endTime) {
      if (startTime !== "" && endTime !== "") {
        var startAMPM = "am";
        var startMinSplit = startTime.split(" ");
    ...
    get24HourTime: function get24HourTime(time) {
      var data = "";
      ...
      if (time !== "") {
        ...
        if (timeSplit.length === 2) {
          ...
          var minSplit = minute.split(" ");

          if (minSplit.length === 2) {
            minute = parseInt(minSplit[0]);
            var ampm = minSplit[1].toLowerCase();
    ...
    setSlotStyle: function setSlotStyle(recordIndex, rowIndex, slotIndex, slot) {
      var slotId = "ms-" + recordIndex + "-" + rowIndex + "-" + slotIndex;
      ...
      if (document.getElementById(slotId)) {
        ...
        var textColor = this.getTextColor(bgColor);
    ...
    setHourSlotWidth: function setHourSlotWidth() {
      var slotWidth = this.slotWidth;
      var elements = document.getElementsByClassName("hour-slot");
    ...
    colorToRGB: function colorToRGB(color) {
      ...
      if (color.indexOf('rgb') === -1) {
        ...
        var tempElem = document.body.appendChild(document.createElement('whatever'));
...
/* harmony import */ var vue_resize_dist_vue_resize_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-resize/dist/vue-resize.css */ "./node_modules/vue-resize/dist/vue-resize.css");
window.$ = window.jQuery = __webpack_require__(/*! jquery/dist/jquery.min */ "./node_modules/jquery/dist/jquery.min.js");

__webpack_require__(/*! ./main */ "./resources/js/main.js");

__webpack_require__(/*! ./viewComponents */ "./resources/js/viewComponents.js");

__webpack_require__(/*! magicsuggest/magicsuggest-min */ "./node_modules/magicsuggest/magicsuggest-min.js");

__webpack_require__(/*! magicsuggest/magicsuggest-min.css */ "./node_modules/magicsuggest/magicsuggest-min.css");
...
/***/ "./resources/js/viewComponents.js":
/*!****************************************!*\
  !*** ./resources/js/viewComponents.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {

window.StudentTimetable = __webpack_require__(/*! ./components/timetable/StudentTimetable */ "./resources/js/components/timetable/StudentTimetable.vue").default;

/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/magicsuggest/magicsuggest-min.css":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/magicsuggest/magicsuggest-min.css ***!
  \****************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-resize/dist/vue-resize.css":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-resize/dist/vue-resize.css ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.hours-row[data-v-ad130602] {\n    padding: 0;\n    margin-bottom: 5px;\n}\n.hour-slot[data-v-ad130602] {\n    float: left;\n    width: 100px;\n    height: auto;\n    border: 1px solid #dedede;\n    border-right-color: transparent;\n    font-size: 14px;\n    text-align: center;\n    padding: 10px 0;\n}\n.hour-slot[data-v-ad130602]:last-child {\n    border-right-color: #dedede;\n}\n.module-slot-row-container[data-v-ad130602] {\n    padding: 0 !important;\n}\n.module-slot-row[data-v-ad130602] {\n    clear: both;\n    width: 100%;\n    height: auto;\n    margin-bottom: 15px;\n}\n.module-slot[data-v-ad130602] {\n    float: left;\n    width: 100px;\n    height: auto;\n    min-height: 1px;\n    background-color: #5bc0de;\n    color:#FFFFFF;\n}\n.filled-slot[data-v-ad130602] {\n    clear: both;\n    width: 100%;\n    padding: 10px;\n}\n.empty-slot[data-v-ad130602] {\n    clear: both;\n    width: 100%;\n}\n.module-slot-row[data-v-ad130602]  {\n    display:         flex;\n    flex-wrap: wrap;\n}\n.module-slot-row  > .module-slot[data-v-ad130602] {\n    display: flex;\n    flex-direction: column;\n}\n.static-header[data-v-ad130602] {\n    position: relative;\n    z-index: 999;\n    top: 0;\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_magicsuggest_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./magicsuggest-min.css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/magicsuggest/magicsuggest-min.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_magicsuggest_min_css__WEBPACK_IMPORTED_MODULE_1__.default, options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_magicsuggest_min_css__WEBPACK_IMPORTED_MODULE_1__.default.locals || {});
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_vue_resize_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./vue-resize.css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-resize/dist/vue-resize.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_vue_resize_css__WEBPACK_IMPORTED_MODULE_1__.default, options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_vue_resize_css__WEBPACK_IMPORTED_MODULE_1__.default.locals || {});
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_style_index_0_id_ad130602_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_style_index_0_id_ad130602_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/***/ "./resources/js/components/timetable/StudentTimetable.vue":
/*!****************************************************************!*\
  !*** ./resources/js/components/timetable/StudentTimetable.vue ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _StudentTimetable_vue_vue_type_template_id_ad130602_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true& */ "./resources/js/components/timetable/StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true&");
/* harmony import */ var _StudentTimetable_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./StudentTimetable.vue?vue&type=script&lang=js& */ "./resources/js/components/timetable/StudentTimetable.vue?vue&type=script&lang=js&");
/* harmony import */ var _StudentTimetable_vue_vue_type_style_index_0_id_ad130602_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css& */ "./resources/js/components/timetable/StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  _StudentTimetable_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _StudentTimetable_vue_vue_type_template_id_ad130602_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _StudentTimetable_vue_vue_type_template_id_ad130602_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "ad130602",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/timetable/StudentTimetable.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/timetable/StudentTimetable.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/components/timetable/StudentTimetable.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentTimetable.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/timetable/StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css&":
/*!*************************************************************************************************************************!*\
  !*** ./resources/js/components/timetable/StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css& ***!
  \*************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_style_index_0_id_ad130602_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=style&index=0&id=ad130602&scoped=true&lang=css&");


/***/ }),

/***/ "./resources/js/components/timetable/StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true&":
/*!***********************************************************************************************************!*\
  !*** ./resources/js/components/timetable/StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true& ***!
  \***********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_template_id_ad130602_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_template_id_ad130602_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentTimetable_vue_vue_type_template_id_ad130602_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/timetable/StudentTimetable.vue?vue&type=template&id=ad130602&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    _c("div", { staticClass: "card" }, [
      _c(
        ...
        [
          _c(
            "div",
            { staticClass: "row static-header", attrs: { id: "tt-header" } },
            [
                  ...
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "row" }, [
                      ...
                      _c(
                        "div",
                        {
                          staticClass: "col-md-11 hours-row",
                          attrs: { id: "hours-row" }
                        },
                        [
                          _c("resize-observer", {
                            on: { notify: _vm.onWindowResize }
                          }),
                          _vm._v(" "),
                          _vm._l(_vm.hourSlots, function(time) {
                            return _c("div", { staticClass: "hour-slot" }, [
                              _c("strong", [_vm._v(_vm._s(time))])
                            ])
                          })
                        ],
                        2
          ...
          _vm._v(" "),
          _vm._l(_vm.uiRecords, function(record, recordIndex) {
                    ...
                    _c("div", { staticClass: "row" }, [
                      _c("div", { staticClass: "col-md-1" }, [
                        _c("div", { staticClass: "date-text" }, [
                          _c("strong", [_vm._v(_vm._s(record.date))])
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "day-text" }, [
                          _c("strong", [_vm._v(_vm._s(record.weekDay))])
                        ])
                      ]),
                      _vm._v(" "),
                      _c(
                        "div",
                        { staticClass: "col-md-11 module-slot-row-container" },
                        _vm._l(record.rows, function(row, rowIndex) {
                          return _c(
                            "div",
                            { staticClass: "module-slot-row" },
                            _vm._l(row, function(slot, slotIndex) {
                              return _c(
                                "div",
                                {
                                  staticClass: "module-slot",
                                  attrs: {
                                    id:
                                      "ms-" +
                                      recordIndex +
                                          ...
                                          _c("div", { staticClass: "row" }, [
                                            ...
                                            _c(
                                              ...
                                              [
                                                ...
                                                _vm._v(" "),
                                                _vm._l(slot.lecturers, function(
                                                  lecturer
                                                ) {
                                                  return _c(
                                                    "div",
                                            ...
                                            _c(
                                              ...
                                              [
                                                _c("strong", [
                                                  _vm._v("Lecture Hall(s)")
                                                ]),
                                                _vm._v(" "),
                                                _vm._l(slot.spaces, function(
                                                  space
                                                ) {
                                                  return _c(
                                                    "div",
