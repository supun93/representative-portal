                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-11 hours-row" id="hours-row" :ref="'hoursRow'">
...
export default {
    ...
    methods: {
        ...
        hasTaken(startTime, endTime, takenSlots)
        {
            ...
            {
                startTime = "2020-12-27 "+obj.get24HourTime(startTime);
                startTime = new Date(startTime);
                endTime = "2020-12-27 "+obj.get24HourTime(endTime);
                ...
                takenSlots.forEach(function (takenSlot) {
                    ...
                    slotStart = "2020-12-27 "+obj.get24HourTime(slotStart);
                    slotStart = new Date(slotStart);
                    slotEnd = "2020-12-27 "+obj.get24HourTime(slotEnd);
