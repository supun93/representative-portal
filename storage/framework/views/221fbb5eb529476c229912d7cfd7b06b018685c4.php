...
<div class="card">
    ...
    <div class="col-md-12">
        ...
        <div class='col-md-8'>
        <h6>: <?php echo e($student->getCountry->citizenship ?? ''); ?></h6><hr/>
        </div>
        <div class='col-md-3'>
        <h6>NIC/Passport</h6>
        </div>
        ...
        <div class='col-md-8'>
        <h6>: <?php echo e($student->kiu_mail); ?></h6><hr/>
        </div>
        <div class='col-md-3'>
        <h6>1st Mobile Number</h6>
        </div>
        <div class='col-md-8'>
        <h6>: <?php echo e($student->tel_mobile1); ?></h6><hr/>
        </div>
        <div class='col-md-1'>
        <a href='<?php echo e(route("details-change.main")); ?>?det=mobile1' class='btn btn-xs btn-info'>Change</a>
        </div>
        <div class='col-md-3'>
        <h6>2nd Mobile Number</h6>
        </div>
        <div class='col-md-8'>
        <h6>: <?php echo e($student->tel_mobile2); ?></h6><hr/>
        </div>
        <?php if($student->tel_mobile2 != null): ?>
        <div class='col-md-1'>
        <a href='<?php echo e(route("details-change.main")); ?>?det=mobile2' class='btn btn-xs btn-info'>Change</a>
        </div>
        <?php endif; ?>
        <div class='col-md-3'>
        <h6>Resident Telephone</h6>
        </div>
        <div class='col-md-8'>
        <h6>: <?php echo e($student->tel_residence); ?></h6><hr/>
        </div>
        <div class='col-md-3'>
        <h6>Work Telephone</h6>
        </div>
        <div class='col-md-8'>
        ...
        <div class='col-md-3'>
            <h6>Grama Niladhari Division</h6>
        </div>
        <div class='col-md-8'>
            <h6>: <?php echo e($student->gramaNiladhariDivision->name_en ?? ''); ?></h6><hr/>
        </div>
        </div>
        </div>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\push student portal\kiu-student-portal\resources\views/details/main.blade.php ENDPATH**/ ?>