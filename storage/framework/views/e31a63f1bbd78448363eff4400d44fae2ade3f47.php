    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-child-indent" data-widget="treeview"
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('exam-timetable.list')); ?>" class="nav-link <?php echo e((request()->segment(1) == 'details') ? 'active' : ''); ?> ">
                        <i class="nav-icon far fa-calendar-alt"></i>
                        <p>Exam TimeTable</p>
                    </a>
                </li>
...
<?php /**PATH C:\xamppp\htdocs\push student portal\kiu-student-portal\resources\views/layouts/leftmenu.blade.php ENDPATH**/ ?>