...
<head>
  ...
  <?php if($pageTitle ?? ''!=""): ?>
  <title>KIU Student Portal | <?php echo e($pageTitle ?? '' ?? ''); ?></title>
<?php else: ?>
...
<body class="sidebar-mini text-sm">
  ...
  <?php echo $__env->make('layouts.topnavi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <!-- /.navbar -->
...
<?php /**PATH C:\xamppp\htdocs\push student portal\kiu-student-portal\resources\views/layouts/master.blade.php ENDPATH**/ ?>